---
title: SAT RW 2025年6月第1套（亚太A）错题分析
tags:
  - SAT
  - Reading
  - 错题
...
```mermaid
flowchart LR
    A[主语: The fibularis longus and the brachialis] --> B[插入语: which are skeletal muscles<br>非限制性定语从句]
    B --> C[谓语: are cylindrical in shape and help move...]
    C --> D[✓ C: 从句紧贴先行词 + 双逗号隔离]
```
...
```mermaid
flowchart TD
    A[直觉: 有些情形下说谎可能允许] --> B[问题: 那凭什么反对说谎?]
    B --> C[Pallikkathayil 的回答]
    C --> D[尊重他人能动性利益的义务]
    D --> E[错误信念约束能动性]
    E --> F[一般应说真话<br>除非能防止更大的约束]
    F --> G[✓ C: 证成反对说谎的框架<br>truthfulness + 例外条款]
```
