...
> [!tip] 💡 一句话直觉
> 麦克斯韦方程组 = **电磁世界的「交通规则」**，四条规则说了四件事：
> 1. **电荷产生电场**（高斯定律）
> 2. **没有磁单极子**（磁场线永远是闭合的）
> 3. **变化磁场产生电场**（法拉第定律）
> 4. **电流和变化电场都产生磁场**（安培-麦克斯韦定律）
> 
> 前两条是静态规律，后两条是动态耦合——**变化的电场产生磁场，变化的磁场产生电场**，这就是电磁波能自我传播的原因！
...
> [!tip] 💡 为什么位移电流如此重要？
> 没有位移电流，电磁波就无法存在！因为电磁波在真空中传播时没有电荷也没有传导电流——全靠**变化的电场产生磁场**（位移电流充当「电流源」）、**变化的磁场产生电场**（法拉第定律），两者互相激发、向前传播。
> 
> 🌍 **类比**：就像你推一个秋千——你推一下（电场变），秋千荡起来（磁场生），秋千荡回来又推动你（磁场变→电场生），如此循环。
...
> [!question] 🤔 为什么 $\mu_0$ 和 $\varepsilon_0$ 能算出光速？
> $c = 1/\sqrt{\mu_0\varepsilon_0}$ 是两个**电磁常数**的组合，计算结果恰好等于测量到的光速。这绝非巧合——**光就是电磁波**！麦克斯韦在 1865 年做出这个预言时，这是物理学史上最激动人心的时刻之一。
...
> [!summary] 🎯 核心要点
> 麦克斯韦方程组统一了电学、磁学和光学。四条方程 + 洛伦兹力公式 = 整个经典电磁学的全部内容。把它们记住，你就掌握了电磁学的终极密码 🔐
