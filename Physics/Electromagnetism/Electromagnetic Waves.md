...
> [!tip] 💡 一句话直觉
> 电磁波 = **互相激发的电场和磁场像涟漪一样在空间中传播**：
> - 变化的电场 → 产生磁场
> - 变化的磁场 → 产生电场
> - 如此循环，不需要任何介质就能在真空中传播
> - 这就像水面上的波纹——丢一颗石子（扰动），波纹就自动向外扩散
> - **光就是电磁波**——你眼睛看到的一切，都是电磁波
...
> [!tip] 💡 为什么电磁波是横波？
> 因为产生电磁波的是**横向扰动**（变化电场和变化磁场互相垂直），就像你甩动一根绳子——你上下晃动手腕，波就沿着绳子向前传播，绳子本身的运动方向（上下）垂直于传播方向（水平）。电磁波也是类似的道理。
...
> [!tip] 💡 可见光只是冰山一角
> 人眼能看到的可见光（400-700nm）在整个电磁波谱中只占**不到一个八度**。无线电波、微波、红外线、紫外线、X 射线和 γ 射线虽然肉眼看不到，但本质与光完全相同——都是电磁波，都以光速 $c$ 传播，区别仅在于**频率（波长）不同**。频率越高，单个光子携带的能量越大（这就是为什么 X 射线和 γ 射线能穿透组织甚至造成辐射伤害）。
