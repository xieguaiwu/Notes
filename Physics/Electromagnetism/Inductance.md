...
> - 电流想增加 → 电感产生反向电压**拖后腿**
> - 电流想减少 → 电感产生同向电压**挽留它**
> - 所以电感的电流**不能突变**——就像大货车的速度不能瞬间改变
> - 电容是电压不能突变，电感是电流不能突变，两者互为**对偶**
...
> [!warning] ⚠️ 断开电感的危险
> 电感中的电流不能突变——当你突然断开电路时，$dI/dt$ 极大，会产生极大的反向电压（$V = L\,dI/dt$），足以击穿空气产生火花！这就是为什么继电器和电机电路需要**续流二极管**来保护。
...
> [!tip] 💡 LC 振荡的直觉
> LC 振荡就像**弹簧振子**：
> - 电容储能 $\frac{1}{2}CV^2$ = 弹簧的**势能**（位置能量）
> - 电感储能 $\frac{1}{2}LI^2$ = 弹簧的**动能**（运动能量）
> - 两者周期性地互相转换，就像钟摆来回摆动
> - 频率 $f = 1/(2\pi\sqrt{LC})$ 完全由 $L$ 和 $C$ 决定——这就是为什么收音机能通过调 $L$ 或 $C$ 来选择频道
...
> [!summary] 🎯 核心要点
> 电感 = 电路的惯性，抗拒电流变化。与电容（抗拒电压变化）恰好对偶。两者组合（LC）产生振荡，是无线电、时钟电路的基础。
